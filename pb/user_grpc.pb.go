...
const (
	...
	User_SetRole_FullMethodName    = "/user.User/SetRole"
)
...
type UserClient interface {
	...
	SetRole(ctx context.Context, in *SetRoleRequest, opts ...grpc.CallOption) (*UserResponse, error)
}
...
func (c *userClient) SetRole(ctx context.Context, in *SetRoleRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserResponse)
	err := c.cc.Invoke(ctx, User_SetRole_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	SetRole(context.Context, *SetRoleRequest) (*UserResponse, error)
...
func (UnimplementedUserServer) SetRole(context.Context, *SetRoleRequest) (*UserResponse, error) {
...
func _User_SetRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetRoleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).SetRole(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_SetRole_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).SetRole(ctx, req.(*SetRoleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
